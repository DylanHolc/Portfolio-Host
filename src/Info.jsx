        ...
        <div className="container-fluid info">
          ...
          <div className="row d-flex justify-content-center text-center mt-5">
            <p className="col-12 col-md-8 mt-4">
              ...
              have experience working with RESTful APIs, databases, and version
              control systems like Git. I am also familiar with Agile
              methodologies and have worked in collaborative team environments.
            </p>
            <p className="col-12 col-md-8 mt-4">
            ...
            <p className="col-12 col-md-8 my-4">
              If you are looking for a dedicated and enthusiastic web developer
              to join your team, please feel free to reach out. I would love to
              connect and discuss potential opportunities. You can find my
              contact information in the footer below or within my résumé which
              can be accessed via the navbar.
            </p>
          </div>
